// ================================================================
//  init-page-root.js - الإصدار النهائي (الدرع المطلق + v4.1 Fix)
// ================================================================
...
(function() {
  ...
  function safelyExecuteScripts(container) {
    // أخذ لقطة من السكربتات (لأن الحذف سيغير الـ DOM أثناء التكرار)
    ...
    scripts.forEach(oldScript => {
      try {
        ...
        // نسخ جميع الخصائص (مهم جداً لـ module)
        Array.from(oldScript.attributes).forEach(attr => {
          newScript.setAttribute(attr.name, attr.value);
        });
        
        if (oldScript.src) {
          // إضافة bust cache لمنع المشاكل عند التحديث
        ...
        // إضافة السكربت الجديد للـ head
        document.head.appendChild(newScript);
        
        // 🛡️ السر الذي اكتشفته: حذف السكربت القديم بعد النقل
        oldScript.remove(); 
  ...
  console.log('✅ init-page-root.js جاهز (النسخة النهائية v4.1 مع 404)');
})();// ================================================================
//  init-page-root.js - الإصدار النهائي (الدرع المطلق + v4.1 Fix)
// ================================================================
